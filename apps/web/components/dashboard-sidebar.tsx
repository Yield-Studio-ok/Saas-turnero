...
const navItems = [
  ...
  { name: "Catálogo", href: "/dashboard/catalogo", icon: BookOpen },
        ...
        <div className="pt-8 mb-2">
          ...
          {proItems.map((item) => {
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <Icon className={`w-5 h-5 transition-colors ${isActive ? "text-amber-500" : "text-slate-400 group-hover:text-slate-200"}`} />
                  <span>{item.name}</span>
                </div>
